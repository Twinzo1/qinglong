...
update_qinglong() {
    ...
    reset_romote_url ${dir_root} "${github_proxy_url}https://github.com/Twinzo1/qinglong.git" "master"
    ...
    local url="${github_proxy_url}https://github.com/Twinzo1/qinglong-static.git"
